function Contact() {
    return (
        <div className="max-w-[80vw] mx-auto p-6 bg-gray-900 shadow-md rounded-lg mt-10 bg-opacity-90 border border-gray-700 flex flex-col items-center">
            <h2 className="text-3xl font-bold mb-4 text-center text-green-400">Contato Oficial do BTG</h2>
            <div className="flex flex-col items-center">
                <div className="relative flex justify-center mb-6">
                    <img
                        className="w-48 h-48 sm:w-64 sm:h-64 md:w-80 md:h-80 object-top object-cover rounded-full border-4 border-green-500"
                        src="https://i.ibb.co/X5v1mRh/Whats-App-Image-2024-06-08-at-21-41-41.jpg"
                        alt="Foto de perfil do desenvolvedor do BTG"
                    />
                ...
                <p className="text-lg text-gray-300 mb-6 text-center px-4 md:px-0">
                    Eu sou <strong className="text-green-300">Nicolas Rosa</strong>, responsável pelo desenvolvimento da interface e sistemas de informação do <strong className="text-green-400">BTG – Batalhão de Tecnologia para Guerra</strong>.
                    Especialista em aplicações web, interfaces modernas e integração de tecnologias para fins estratégicos e operacionais.
                </p>
            </div>

            <div className="flex space-x-4 mb-6 justify-center">
                <a href="https://github.com/Nicolas-rosa" target="_blank" className="text-gray-300 hover:text-green-400">
                    <i className="fab fa-github fa-2x"></i>
                </a>
                <a href="mailto:nicolasfrancacastrorosa@gmail.com" target="_blank" className="text-gray-300 hover:text-green-400">
                    <i className="fas fa-envelope fa-2x"></i>
                </a>
                <a href="https://www.linkedin.com/in/nicolas-rosa-dev" target="_blank" className="text-gray-300 hover:text-green-400">
